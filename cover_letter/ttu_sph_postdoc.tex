...
\recipient{To}{The Project Incharge, \\
               ...
               Texas, USA}
\date{\today}
\opening{\textbf{Sub: Post Doctoral Research Associate - Mechanical Engineering}}
...
multiphase flow challenges using these methods will help me solving the
drop-wall interaction problem which the current project is looking for.\\
