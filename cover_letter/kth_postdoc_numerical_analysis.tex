...
\recipient{To}{Prof. Sara Zahedi, \\
               KTH Royal Institute of Technology,\\
               Sweden}
\date{\today}
\opening{\textbf{Sub: Postdoc in numerical analysis.}}
...
multiphase flow challenges using these methods will bring significant
value to the institution and contribute meaningfully to the success of
the project.\\
